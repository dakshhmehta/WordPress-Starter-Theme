<?php
    ...
    $sampleHTML = '';
    if ( file_exists( dirname( __FILE__ ) . '/infcore/redux-options/o-html.html' ) ) {
        Redux_Functions::initWpFilesystem();

        global $wp_filesystem;

        $sampleHTML = $wp_filesystem->get_contents( dirname( __FILE__ ) . '/infcore/redux-options/o-html.html' );
    }
    ...
    $args['intro_text'] = sprintf( __( '<p>From here, you can change the theme options and settings that will help you to customize the theme as you like to.</p>', 'redux-framework' ), $v );
    ...
    $tabs = array(
        array(
            'id'      => 'about-author',
            'title'   => __( 'Credits', 'redux-framework' ),
            'content' => __( '<p>Team Romin Interactive</p>', 'redux-framework' )
        ),
    );
    ...
    if ( file_exists( dirname( __FILE__ ) . '/HELP.md' ) ) {
        $section = array(
            'icon'   => 'el el-list-alt',
            'title'  => __( 'Documentation', 'redux-framework' ),
            'fields' => array(
                array(
                    ...
                    'type'     => 'raw',
                    'markdown' => true,
                    'content'  => file_get_contents( dirname( __FILE__ ) . '/HELP.md' )
                ),
            ),
        );
